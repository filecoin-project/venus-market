...
var paychAddFundsCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 3 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass three arguments: <from> <to> <available funds>"))
		}
...
var paychVoucherCreateCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 2 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass two arguments: <channel> <amount>"))
		}
...
var paychVoucherCheckCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 2 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass payment channel address and voucher to validate"))
		}
...
var paychVoucherAddCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 2 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass payment channel address and voucher"))
		}
...
var paychVoucherListCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 1 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass payment channel address"))
		}
...
var paychStatusCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 1 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass an argument: <channel address>"))
		}
		ctx := cli2.ReqContext(cctx)
...
var paychStatusByFromToCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		if cctx.Args().Len() != 2 {
			return cli2.ShowHelp(cctx, fmt.Errorf("must pass two arguments: <from address> <to address>"))
		}
		ctx := cli2.ReqContext(cctx)
